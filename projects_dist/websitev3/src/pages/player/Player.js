...
import gamesData from "../games/games_data.json"
...
const Player = () => {
  ...
  const mobile = mobileTabletCheck();
  return (
    <div style={style} className="text-center d-flex flex-column align-items-center justify-content-center">
      ...
      <div
        ...
        style={{ width: gameData.width + "px", height: gameData.height + "px" }}
      >
        <iframe
          className="game-frame bg-blackblue"
        ...
        ></iframe>
        <img
          src="/images/logo/logo1_outline.png"
          className="saantonandre"
          alt="logo"
        />
      </div>
    </div>
