window.onload = function () {
    ...
    var DO=new Audio("https://saantonandre.github.io/do2.wav");
    var RE=new Audio("https://saantonandre.github.io/re.wav");
    var MI=new Audio("https://saantonandre.github.io/mi.wav");
    var FA=new Audio("https://saantonandre.github.io/fa2.wav");
    var SOL=new Audio("https://saantonandre.github.io/sol2.wav");
    var LA=new Audio("https://saantonandre.github.io/la.wav");
    var SI=new Audio("https://saantonandre.github.io/si.wav");
    var applause=new Audio("https://saantonandre.github.io/applause.mp3");
    ...
    var once = 0;
    var isRecoil = false;
    var fart = new Audio("https://saantonandre.github.io/fart.mp3");
    var shoot = new Audio("https://saantonandre.github.io/fake2.mp3");
    var pew = new Audio("https://saantonandre.github.io/pew1.mp3");
    var projectileAngle = [];
    var projectile = [];
    var laserAngle = [];
    var laser = [];
    ...
    function shootMp3() {
        if (!farting && !conductorMode) {
            ...
            if(lasergun){
                    shoot = new Audio("https://saantonandre.github.io/pew1.mp3");
                shoot.play();
                playing = 1;
            ...
            if (!lasergun){
                if (random) {
                    shoot = new Audio("https://saantonandre.github.io/fake1.mp3");
                } else {
                    shoot = new Audio("https://saantonandre.github.io/fake2.mp3");
                }
                shoot.play();
                playing = 1;
        ...
        if(conductorMode&&!farting){
            ...
            note=new Audio("https://saantonandre.github.io/la.wav");
            note.play();
            }
            if (angleDeg<=75&&angleDeg>50){
            note=new Audio("https://saantonandre.github.io/si.wav");
            note.play();
            }
            if (angleDeg<=50&&angleDeg>25){
            note=new Audio("https://saantonandre.github.io/do2.wav");
            note.play();
            }
            if (angleDeg<=25&&angleDeg>0){
            note=new Audio("https://saantonandre.github.io/re.wav");
            note.play();
            }
            if (angleDeg<=0&&angleDeg>-25){
            note=new Audio("https://saantonandre.github.io/mi.wav");
            note.play();
            }
            if (angleDeg<=-25&&angleDeg>-60){
            note=new Audio("https://saantonandre.github.io/fa2.wav");
            note.play();
            }
            if (angleDeg<=-60&&angleDeg>-90){
            note=new Audio("https://saantonandre.github.io/sol2.wav");
            note.play();
            }
        }
    }
    ...
    function fartFunc() {
        ...
        if (supportsVibrate){
            ...
            clearTimeout(fart);
            fart = new Audio("https://saantonandre.github.io/fart.mp3");
            fart.play();
            farting = 1;
            goBack = 0;
            flowY = 0;
