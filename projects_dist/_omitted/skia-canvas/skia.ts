import * as skialib from "skia-canvas";
import EventEmitter from "node:events";

const { Window, ...rest } = skialib;
...
type WindowCustom = Window & EventEmitter<WindowEventsMap>;
const skia = { ...rest, Window: Window as unknown as WindowCustom };
export default skia;
