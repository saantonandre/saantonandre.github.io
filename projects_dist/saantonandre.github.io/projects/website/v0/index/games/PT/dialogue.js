...
0 - Player (0 = normal, 1 = disappointed, 2 = angry, 3 = amazed, 4 = frightened)

1 - Esther (0 = normal, 1 = playful, 2 = hehe )

2 - Officer (0 = normal, 1 = slightly angry)

3 - GhostGirl (0 = normal, 1 = worried, 2 = laughing)

4 - Overlord (0 = normal, 1 = thinking)
*/
...
class DialogueEngine {
    constructor() {
        ...
        this.speaker = 0;
        this.portraits = [0, 80, 160, 240, 320, 400];
        this.emotion = 3;
    ...
    areThereImputs() {
        ...
        if ((!controls.up && !controls.e) && this.buttonPressed) {
    ...
    compute() {
        ...
        this.textbox.y = this.templateY + 23 * GLOBAL.ratio;
        ...
        this.nextLetter();
        if (!this.finished) {
            if (sounds.voices[this.speaker][this.currentAudio].paused) {
                this.currentAudio = (Math.random() * 6) | 0;
                sounds.voices[this.speaker][this.currentAudio].playy();
            }
        } else {
            sounds.voices[this.speaker][this.currentAudio].pause();
        }
    }
    render() {
        if (!this.active) {
...
*/
        ...
        c.drawImage(
            ...
            96,
            32,
            this.templateX + (304 * GLOBAL.ratio),
            this.templateY,
            96 * GLOBAL.ratio,
            32 * GLOBAL.ratio
        )
