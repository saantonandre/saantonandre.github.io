...
function vitePluginArraybuffer() {
  return {
    ...
    resolveId(id) {
      if (id.endsWith("?arraybuffer") || id.endsWith("?uint8array") || id.endsWith("?arraybuffer&base64") || id.endsWith("?uint8array&base64") || id === "virtual:decode-64") {
        return id;
      }
      return;
    },
...
export {
  vitePluginArraybuffer as default
};
