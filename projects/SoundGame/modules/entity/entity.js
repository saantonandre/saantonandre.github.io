import { checkCollisions, simpleCollisionCheck } from "../physics/checkCollisions.js";
...
export class Entity extends Sprite {
    constructor(x, y) {
        ...
        this.checkCollisions = simpleCollisionCheck;
     ...
     * @param {Camera | any} camera Optional Camera abstraction representing an offset relative to the map (0,0) coordinates
     */
    renderHitbox(context, tilesize, ratio, camera = {x:0, y:0}) {
        context.fillRect(
